# -*- coding: utf-8 -*-
# SKYRYBOS ATSTATYMAS tarp ausų ir vertėjo (perkelta iš Diktuoklės 09-12).
#
# Kodėl jis čia: ausys duoda tekstą BE skyrybos ir be didžiųjų, o OPUS-MT mokytas ant
# tvarkingo rašytinio teksto. Gyvai 09-12 tai davė haliucinaciją: „na ką pakalbėsime kaip
# dirba medienos pramonė lietuvoje" → „…в России" (Lietuva tapo Rusija). Su atstatyta
# skyryba tas pats sakinys verčiamas teisingai.
#
# Pamatuota (`_matavimas\SKYRYBA_PRIES_VERTIMA.md`, 8 tikri ausų tekstai, Gemma 31B 1–5):
#   be skyrybos 4,12 · su skyryba 5,00 — visi aštuoni gavo aukščiausią balą.
# Kaina: 0,25–0,29 s gabalui, krovimas 2,9 s. Veikia lt/ru/en/de.
#
# Modelis — Kristijono Jakubsono `punct_restore` (Apache 2.0), tas pats, kurį naudoja
# Diktuoklė. Kodas perkeltas NEPAKEISTAS.
